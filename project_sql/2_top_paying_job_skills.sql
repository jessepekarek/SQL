...
SQL - 9/10 jobs (90%) ⭐
Python - 8/10 jobs (80%) ⭐
Tableau - 6/10 jobs (60%)
R - 4/10 jobs (40%)
Excel - 4/10 jobs (40%)

The "Big 3" still dominate: SQL, Python, Tableau
Correlation: 0.387 (moderate but weak)
R² = 0.15 (only 15% of salary explained by # of skills)
What this means:

More skills ≠ guaranteed higher pay
Other factors matter MORE (seniority, industry, location)
Having 14 skills doesn't guarantee top salary

Example:

$189K job has 14 skills
$217K job has only 5 skills!

Takeaway: Focus on the RIGHT skills 
(SQL, Python, Tableau), not just MORE skills.
